...
HX_DEFINE_STACK_FRAME(_hx_pos_1d6de1494ff6b479_353_new,"substates.GameplayOption","new",0xffbadbb9,"substates.GameplayOption.new","substates/GameplayChangersSubstate.hx",353,0x349481a9)
HX_LOCAL_STACK_FRAME(_hx_pos_1d6de1494ff6b479_430_change,"substates.GameplayOption","change",0x929863b7,"substates.GameplayOption.change","substates/GameplayChangersSubstate.hx",430,0x349481a9)
HX_LOCAL_STACK_FRAME(_hx_pos_1d6de1494ff6b479_437_getValue,"substates.GameplayOption","getValue",0xdf83c102,"substates.GameplayOption.getValue","substates/GameplayChangersSubstate.hx",437,0x349481a9)
HX_LOCAL_STACK_FRAME(_hx_pos_1d6de1494ff6b479_441_setValue,"substates.GameplayOption","setValue",0x8de11a76,"substates.GameplayOption.setValue","substates/GameplayChangersSubstate.hx",441,0x349481a9)
HX_LOCAL_STACK_FRAME(_hx_pos_1d6de1494ff6b479_446_setChild,"substates.GameplayOption","setChild",0xa1e244a1,"substates.GameplayOption.setChild","substates/GameplayChangersSubstate.hx",446,0x349481a9)
HX_LOCAL_STACK_FRAME(_hx_pos_1d6de1494ff6b479_450_get_text,"substates.GameplayOption","get_text",0x1aa8ba3d,"substates.GameplayOption.get_text","substates/GameplayChangersSubstate.hx",450,0x349481a9)
HX_LOCAL_STACK_FRAME(_hx_pos_1d6de1494ff6b479_457_set_text,"substates.GameplayOption","set_text",0xc90613b1,"substates.GameplayOption.set_text","substates/GameplayChangersSubstate.hx",457,0x349481a9)
HX_LOCAL_STACK_FRAME(_hx_pos_1d6de1494ff6b479_465_get_type,"substates.GameplayOption","get_type",0x1ab7e04a,"substates.GameplayOption.get_type","substates/GameplayChangersSubstate.hx",465,0x349481a9)
namespace substates{
...
void GameplayOption_obj::__construct(::String name,::String variable,::String __o_type, ::Dynamic __o_defaultValue,::Array< ::String > options){
            	...
            	HX_STACKFRAME(&_hx_pos_1d6de1494ff6b479_353_new)
HXLINE( 377)		this->name = HX_("Unknown",6a,4b,cc,ae);
HXLINE( 376)		this->displayFormat = HX_("%v",b1,20,00,00);
HXLINE( 374)		this->decimals = 1;
HXLINE( 373)		this->maxValue = null();
HXLINE( 372)		this->minValue = null();
HXLINE( 371)		this->changeValue = 1;
HXLINE( 370)		this->options = null();
HXLINE( 369)		this->curOption = 0;
HXLINE( 367)		this->defaultValue = null();
HXLINE( 366)		this->variable = null();
HXLINE( 364)		this->scrollSpeed = ((Float)50);
HXLINE( 363)		this->showBoyfriend = false;
HXLINE( 359)		this->type = HX_("bool",2a,84,1b,41);
HXLINE( 357)		this->onChange = null();
HXLINE( 381)		this->name = name;
HXLINE( 382)		this->variable = variable;
HXLINE( 383)		this->type = type;
HXLINE( 384)		this->defaultValue = defaultValue;
HXLINE( 385)		this->options = options;
HXLINE( 387)		if (::hx::IsEq( defaultValue,HX_("null variable value",06,3c,3f,e9) )) {
HXLINE( 389)			::String _hx_switch_0 = type;
            			if (  (_hx_switch_0==HX_("bool",2a,84,1b,41)) ){
HXLINE( 392)				defaultValue = false;
HXDLIN( 392)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==HX_("float",9c,c5,96,02)) ||  (_hx_switch_0==HX_("int",ef,0c,50,00)) ){
HXLINE( 394)				defaultValue = 0;
HXDLIN( 394)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==HX_("percent",c5,aa,da,78)) ){
HXLINE( 396)				defaultValue = 1;
HXDLIN( 396)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==HX_("string",d1,28,30,11)) ){
HXLINE( 398)				defaultValue = HX_("",00,00,00,00);
HXLINE( 399)				if ((options->length > 0)) {
HXLINE( 400)					defaultValue = options->__get(0);
            				}
HXLINE( 397)				goto _hx_goto_0;
            			}
            			_hx_goto_0:;
            		}
HXLINE( 405)		if (::hx::IsNull( this->getValue() )) {
HXLINE( 406)			this->setValue(defaultValue);
            		}
HXLINE( 409)		::String _hx_switch_1 = type;
            		if (  (_hx_switch_1==HX_("percent",c5,aa,da,78)) ){
HXLINE( 418)			this->displayFormat = HX_("%v%",54,7a,1c,00);
HXLINE( 419)			this->changeValue = ((Float)0.01);
HXLINE( 420)			this->minValue = 0;
HXLINE( 421)			this->maxValue = 1;
HXLINE( 422)			this->scrollSpeed = ((Float)0.5);
HXLINE( 423)			this->decimals = 2;
HXLINE( 417)			goto _hx_goto_1;
            		}
            		if (  (_hx_switch_1==HX_("string",d1,28,30,11)) ){
HXLINE( 412)			int num = options->indexOf(this->getValue(),null());
HXLINE( 413)			if ((num > -1)) {
HXLINE( 414)				this->curOption = num;
            			}
HXLINE( 411)			goto _hx_goto_1;
            		}
            		_hx_goto_1:;
            	}
...
void GameplayOption_obj::change(){
            	HX_STACKFRAME(&_hx_pos_1d6de1494ff6b479_430_change)
HXDLIN( 430)		if (::hx::IsNotNull( this->onChange )) {
HXLINE( 431)			this->onChange();
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(GameplayOption_obj,change,(void))
 ...
 ::Dynamic GameplayOption_obj::getValue(){
            	HX_STACKFRAME(&_hx_pos_1d6de1494ff6b479_437_getValue)
HXDLIN( 437)		return ::backend::ClientPrefs_obj::data->gameplaySettings->get(this->variable);
            	}
...
void GameplayOption_obj::setValue( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_1d6de1494ff6b479_441_setValue)
HXDLIN( 441)		::backend::ClientPrefs_obj::data->gameplaySettings->set(this->variable,value);
            	}
...
void GameplayOption_obj::setChild( ::objects::Alphabet child){
            	HX_STACKFRAME(&_hx_pos_1d6de1494ff6b479_446_setChild)
HXDLIN( 446)		this->child = child;
            	}
...
::String GameplayOption_obj::get_text(){
            	HX_STACKFRAME(&_hx_pos_1d6de1494ff6b479_450_get_text)
HXLINE( 451)		if (::hx::IsNotNull( this->child )) {
HXLINE( 452)			return this->child->text;
            		}
...
::String GameplayOption_obj::set_text(::String __o_newValue){
            	...
            	HX_STACKFRAME(&_hx_pos_1d6de1494ff6b479_457_set_text)
HXLINE( 458)		if (::hx::IsNotNull( this->child )) {
HXLINE( 459)			this->child->set_text(newValue);
            		}
...
::String GameplayOption_obj::get_type(){
            	HX_STACKFRAME(&_hx_pos_1d6de1494ff6b479_465_get_type)
HXLINE( 466)		::String newValue = HX_("bool",2a,84,1b,41);
HXLINE( 467)		::String _hx_switch_0 = ::StringTools_obj::trim(this->type.toLowerCase());
            		if (  (_hx_switch_0==HX_("fl",46,59,00,00)) ){
HXLINE( 472)			newValue = HX_("float",9c,c5,96,02);
HXDLIN( 472)			goto _hx_goto_9;
            		}
            		if (  (_hx_switch_0==HX_("integer",be,bd,1b,17)) ){
HXLINE( 470)			newValue = HX_("int",ef,0c,50,00);
HXDLIN( 470)			goto _hx_goto_9;
            		}
            		if (  (_hx_switch_0==HX_("str",b1,a8,57,00)) ){
HXLINE( 471)			newValue = HX_("string",d1,28,30,11);
HXDLIN( 471)			goto _hx_goto_9;
            		}
...
HXLINE( 469)			newValue = this->type;
HXDLIN( 469)			goto _hx_goto_9;
            		}
            		_hx_goto_9:;
HXLINE( 474)		this->type = newValue;
HXLINE( 475)		return this->type;
            	}
