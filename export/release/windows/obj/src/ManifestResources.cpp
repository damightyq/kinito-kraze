...
HXLINE(  71)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_kongtext_ttf >());
...
HXLINE(  79)		 ::Dynamic data;
HXDLIN(  79)		 ::Dynamic manifest;
HXDLIN(  79)		 ::Dynamic bundle;
HXLINE(  81)		{
HXLINE(  81)			::String v = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  81)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v);
            		}
HXLINE(  79)		 ::lime::utils::AssetLibrary library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
